...
const PrivacyPolicy = () => {
  return (
    <section className="py-10 bg-white min-h-screen text-black">
      <div className="container mx-auto w-4/5 text-justify">
        <div className="flex flex-col">
          <div>
            ...
            <h4 className="text-xl font-semibold mb-2">Disclaimer</h4>
            ...
            <p className="text-base font-bold leading-6 mb-4">
            This site is for information purpose only and should not be treated as the official website.
            </p>

            <h3 className="text-2xl font-semibold mb-0">Privacy Policy</h3>
            <p className="text-base font-light leading-6 mb-4">
            ...
            <h3 className="text-2xl font-semibold mb-0">Updation of privacy policy</h3>
            <p className="text-base font-light leading-6 mb-4">
            This privacy policy is subject to undergo change and review without any prior notice or approval. So to keep yourself updated on the changes introduced, please keep visiting and reviewing the terms and conditions of this privacy policy.
            </p>

            <h3 className="text-2xl font-semibold mb-0">User information</h3>
            <p className="text-base font-light leading-6 mb-4">
            ...
            <h3 className="text-2xl font-semibold mb-0">Security</h3>
            <p className="text-base font-light leading-6 mb-4">
